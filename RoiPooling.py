...
class RoiPooling(Layer):
    ...
    def __init__(self, pool_list, num_rois,in_roi, **kwargs):
        ...
        self.in_roi=tf.constant(in_roi,tf.float32)
        print("IN Roipooling INIT: ",type(self.in_roi))
    ...
    def compute_output_shape(self, input_shape):
        print("__compute_outputhsape__input shape",input_shape)
    ...
    def call(self, x, mask=None):
        ...
        img = x[0]
        rois = self.in_roi
#        print("rois, roistype ",rois,type(rois),sep=' || ')
