    ...
    def infer(queries, db):
        ...
        for (i,ref) in enumerate(indices1_at_1000): 
            for (j, ref2) in enumerate(ref[:N]):
                if ref2 in indices2_at_1000[i] and ref2 in indices3_at_1000[i]:
                    new_sim_matrix[i][ref2]*=1.5
                elif ref2 in indices2_at_1000[i] or ref2 in indices3_at_1000[i]:
                    new_sim_matrix[i][ref2]*=1.2
                else:
                    pass
